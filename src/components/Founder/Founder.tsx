              ...
              <div className="flex flex-wrap gap-4">
                {founder.links.website && (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 rounded-lg border border-emerald-100 bg-[#f8fff5] px-4 py-2 text-slate-700 transition-colors hover:bg-[#eefbe9] focus-visible:ring-2 focus-visible:ring-[#62C743] focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                  >
